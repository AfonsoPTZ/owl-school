  ...
  <nav class="bg-dark text-white p-3 vh-100" style="width:220px; position:fixed;">
    ...
    <ul class="nav flex-column">
      ...
      <li class="nav-item mb-2">
        <a class="nav-link text-white" href="admin.html">🏠 Início</a>
      </li>
      ...
      <li class="nav-item mb-2">
        <a class="nav-link text-white" href="comunicado.html">📢 Comunicados</a>
      </li>

      <li class="nav-item mb-2">
        <a class="nav-link text-white" href="advertencia.html">⚠️ Advertências</a>
      </li>
