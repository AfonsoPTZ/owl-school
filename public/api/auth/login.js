document.getElementById("formLogin").onsubmit = async function (e) {
  ...
  try {
    ...
    if (tipo === "aluno") {
      window.location.href = "/owl-school/public/aluno/aluno.html";
    } else if (tipo === "professor") {
      window.location.href = "/owl-school/public/professor/professor.html";
    } else if (tipo === "responsavel") {
      window.location.href = "/owl-school/public/responsavel/responsavel.html";
    } else if (tipo === "admin") {
      window.location.href = "/owl-school/public/admin/admin.html";
    } else {
